...
If you want to run them in Postman, please download the **hms-assignment.postman_collection.json** file in the current repository and export in your local machine's Postman client.
